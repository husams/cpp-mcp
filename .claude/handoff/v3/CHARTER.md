...
handoff_dir: /Users/husam/workspace/cpp-mcp/.claude/handoff/v3/
...
Blackboard paths (authoritative):
  ...
  adrs:           /Users/husam/workspace/cpp-mcp/.claude/handoff/v3/adr-<n>.md   (one per decision)
  plan:           /Users/husam/workspace/cpp-mcp/.claude/handoff/v3/plan.md
  impl-notes:     /Users/husam/workspace/cpp-mcp/.claude/handoff/v3/implementation-notes.md
  impl-notes-per: /Users/husam/workspace/cpp-mcp/.claude/handoff/v3/logs/developer-<story-slug>.md
  test-report:    /Users/husam/workspace/cpp-mcp/.claude/handoff/v3/test-report.md
  test-report-per:/Users/husam/workspace/cpp-mcp/.claude/handoff/v3/logs/qa-engineer-<story-slug>.md
  deploy-notes:   /Users/husam/workspace/cpp-mcp/.claude/handoff/v3/deploy-notes.md
  runbook:        /Users/husam/workspace/cpp-mcp/.claude/handoff/v3/runbook.md
  docs-changes:   /Users/husam/workspace/cpp-mcp/.claude/handoff/v3/docs-changes.md
  logs:           /Users/husam/workspace/cpp-mcp/.claude/handoff/v3/logs/<role>.md
...
Project context:
  ...
  predecessor-run: .claude/handoff/v2/ (FastMCP migration — closed 2026-05-16, 472 tests passing)
  scope-summary: add pluggable graphdb backend (IndraDB) alongside existing Neo4j; URI-scheme dispatch; new DEPENDENCY_MISSING error code.
