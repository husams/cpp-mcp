Feature: Transport — stdio (US-14)
  ...
  Scenario: stdio server exposes all 7 tools
    ...
    And the tools list contains "get_references"
    And the tools list contains "get_type_info"
    And the tools list contains "get_ast"
    And the tools list contains "get_header_info"
    And the tools list contains "get_preprocessor_state"
    And the tools list contains "ingest_code"
