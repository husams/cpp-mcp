...
class TestResolveQueryTimeoutS:
    ...
    def test_valid_value_returned(self, monkeypatch: pytest.MonkeyPatch, value: int) -> None:
    ...
    def test_below_minimum_clamped_to_1(self, monkeypatch: pytest.MonkeyPatch, raw: str) -> None:
    ...
    def test_above_maximum_clamped_to_120(self, monkeypatch: pytest.MonkeyPatch, raw: str) -> None:
        monkeypatch.setenv("CPP_MCP_QUERY_TIMEOUT_SECONDS", raw)
        from cpp_mcp.core.query_config import resolve_query_timeout_s
    ...
    def test_non_integer_defaults_to_30(self, monkeypatch: pytest.MonkeyPatch, raw: str) -> None:
        monkeypatch.setenv("CPP_MCP_QUERY_TIMEOUT_SECONDS", raw)
        from cpp_mcp.core.query_config import resolve_query_timeout_s
